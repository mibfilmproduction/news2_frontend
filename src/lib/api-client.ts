...
export const sportsApi = {
  ...
  getFreeDigest: () => api.get<any>('/sports/external/free/digest', {}, { requireAuth: false }),
  getStandings: (competition = 'bl1') => api.get<any>('/sports/external/standings', { competition }, { requireAuth: false }),
  getSportScoreMatches: (sport: string, limit = 50) => api.get<any[]>('/sports/external/sportscore/matches', { sport, limit }, { requireAuth: false }),
  getSportScoreDetail: (sport: string, slug: string) => api.get<any>('/sports/external/sportscore/match', { sport, slug }, { requireAuth: false }),  getExternalLeagueEvents: (leagueId: string, direction: 'next' | 'past' = 'next') => api.get<any[]>(`/sports/external/leagues/${leagueId}/events`, { direction }, { requireAuth: false }),
