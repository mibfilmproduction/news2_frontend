  ...
  useEffect(() => {
    const fetchEntertainment = async () => {
      try {
        setLoading(true);
        setError(false);
        const categoryResponse = await api.get('/categories/slug/entertainment');
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <p className="text-lg text-gray-500 mb-4">Unable to load entertainment news right now.</p>
