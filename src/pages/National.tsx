  ...
  useEffect(() => {
    const fetchNational = async () => {
      try {
        setLoading(true);
        setError(false);
        const categoryResponse = await api.get('/categories/slug/national');
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <p className="text-lg text-gray-500 mb-4">Unable to load national news right now.</p>
        ...
        <>
          <Tabs defaultValue="all" className="mb-6">
            <TabsList className="w-full justify-start mb-4 bg-transparent border-b border-gray-200 p-0 h-auto">
              <TabsTrigger
                value="all"
                className="data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:shadow-none data-[state=active]:bg-transparent px-4 py-2 data-[state=active]:text-primary"
              >
                All News
              </TabsTrigger>
            </TabsList>
